...
public class ChannelController {
	...
	public ResponseEntity<?> exitChannel(HttpSession session, @PathVariable Long channelId) {
		channelService.exitChannel(session, channelId);
		return ResponseEntity.ok(channelId +" 채널 "+ ChannelStatus.UNACTIVATE.getValue());
	}
}
